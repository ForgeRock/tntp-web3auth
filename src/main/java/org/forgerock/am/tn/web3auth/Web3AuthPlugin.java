...
public class Web3AuthPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(Web3AuthPlugin.currentVersion, 
				Collections.singletonList(Web3Auth.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
		...
		try {
			pluginTools.upgradeAuthNode(Web3Auth.class);
		} catch (Exception e) {
	...
	public String getPluginVersion() {
		return Web3AuthPlugin.currentVersion;
	}
}
